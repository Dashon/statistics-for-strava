  ...
  onScopeChange?: (scope: 'all_time' | 'current_year') => void;
    ...
    return (
      <div className="grid grid-cols-2 md:grid-cols-5 gap-0 rounded-xl overflow-hidden shadow-2xl border border-cyan-900/20 mb-6">
        ...
        {/* Activities */}
        <div className="bg-[#0891b2] p-6 border-l border-cyan-500/20 flex flex-col justify-center">
        ...
        {/* Distance */}
        <div className="bg-[#0e7490] p-6 border-l border-cyan-500/20 flex flex-col justify-center">
        ...
        {/* Time */}
        <div className="bg-[#155e75] p-6 border-l border-cyan-500/20 flex flex-col justify-center">
        ...
        {/* Elevation */}
        <div className="bg-[#164e63] p-6 border-l border-cyan-500/20 flex flex-col justify-center">
