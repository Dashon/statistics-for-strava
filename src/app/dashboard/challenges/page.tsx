        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {allChallenges.map((c) => (
              <div key={c.challengeId} className="flex flex-col items-center gap-4 group">
                  <div className="w-full aspect-square bg-zinc-900 border border-zinc-800 rounded-3xl p-6 flex items-center justify-center group-hover:scale-105 group-hover:border-cyan-500 transition-all shadow-xl hover:shadow-cyan-500/5">
                      {c.logoUrl ? (
