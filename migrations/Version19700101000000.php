...
final class Version19700101000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , distanceInMeter INTEGER NOT NULL, data TEXT NOT NULL --(DC2Type:json)
        , PRIMARY KEY(gearId))');
        $this->addSql('CREATE TABLE KeyValue ("key" VARCHAR(255) NOT NULL, value TEXT NOT NULL, PRIMARY KEY("key"))');
        $this->addSql('CREATE TABLE Segment (segmentId VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, data TEXT NOT NULL --(DC2Type:json)
