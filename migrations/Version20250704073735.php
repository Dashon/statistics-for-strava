...
final class Version20250704073735 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE Activity');
        $this->addSql('CREATE TABLE Activity (data TEXT DEFAULT NULL --(DC2Type:json)
        , streamsAreImported BOOLEAN DEFAULT NULL, activityId VARCHAR(255) NOT NULL, startDateTime TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        , sportType VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, distance INTEGER NOT NULL, elevation INTEGER NOT NULL, calories INTEGER DEFAULT NULL, averagePower INTEGER DEFAULT NULL, maxPower INTEGER DEFAULT NULL, averageSpeed DOUBLE PRECISION NOT NULL, maxSpeed DOUBLE PRECISION NOT NULL, averageHeartRate INTEGER DEFAULT NULL, maxHeartRate INTEGER DEFAULT NULL, averageCadence INTEGER DEFAULT NULL, movingTimeInSeconds INTEGER NOT NULL, kudoCount INTEGER NOT NULL, deviceName VARCHAR(255) DEFAULT NULL, totalImageCount INTEGER NOT NULL, localImagePaths TEXT DEFAULT NULL, polyline TEXT DEFAULT NULL, location TEXT DEFAULT NULL --(DC2Type:json)
        , weather TEXT DEFAULT NULL --(DC2Type:json)
